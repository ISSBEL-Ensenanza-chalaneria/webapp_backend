...
public class Securityconfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(request -> request.requestMatchers(PUBLIC_URL).permitAll().anyRequest().authenticated());
        return http.build();
    }
    ...
    CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000", "https://issbel-ensenanza-chalaneria.github.io"));
